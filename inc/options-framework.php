...
function optionsframework_page() {
    ...
    <?php screen_icon( 'themes' ); ?><h2>FlexFour Settings</h2>
<div>
<h3>Looking for Documentation?</h3>
No sweat, we've got you covered.  <a href="http://lautman.ca/flexfour/" target="_blank">Click here.</a>
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'flexfour' ); ?>" />
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'flexfour' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'flexfour' ) ); ?>' );" />
				<div class="clear"></div>
			</div>
			</form>
		</div> <!-- / #container -->
	</div>
	<?php do_action( 'flexfour_after' ); ?>
	</div>
		<div class="left 40" style="width:35%;margin-left:10px;">
...
<div id="mc_embed_signup">
	...
	<p>Stay informed about new releases and updates to our WordPress themes and plugins, as well our other services.</p>
<form action="http://lautman.us1.list-manage1.com/subscribe/post?u=56f9f9d3be9835a575ebaf919&amp;id=ec61d9a7d0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
...
<div class="mc-field-group">
	...
	</div>	<div class="clear"><input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button button-primary"></div>
</form>
<p>We will never (ever) share or sell your personal information.</p>
</div>

<!--End mc_embed_signup-->
<div id="social-share">
<h2>Why not share the love?</h2>
<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://lautman.ca/flexfour" data-text="I just downloaded FlexFour - an amazing free responsize WordPress theme. Check it out!" data-size="large">Tweet</a>
